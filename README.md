...
21. Stars are **earned as soon as requirements are met** (start at **0★**, cap **3★**): **1★** needs ≥10 population, ≤40 avg stress, and a lobby; **2★** needs ≥30 population, ≤25 avg stress, and at least one elevator; **3★** needs ≥60 population, ≤20 avg stress, lobby + elevator + **Security** + **Housekeeping** + **Maintenance** (facility rooms that are **Broken** do not count). A star can only be **lost** at the **90-day quarterly review** if the current tier no longer qualifies.
...
23. Under **Utility**, place **Housekeeping** and **Maintenance** at **2★** (each auto-hires **1** worker on placement). Select either room and use the **Staff 0–4** stepper to hire or release maids / handymen. **Security Post** is required for **3★** but has no staff UI this slice.
