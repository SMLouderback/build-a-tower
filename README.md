...
22. **Elevators** need **1★**; premium Office / Hotel / Condo variants and **Housekeeping / Maintenance** need **2★**; **Security Post**, **Research Lab**, **Conference Room**, and **Fine Dining** need **3★**; **Event Hall**, **Underground Parking**, and **Valet** need **4★** — locked buttons show the star requirement and stay grey until earned.
