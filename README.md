...
3. Press **Play**.
4. HUD **core strip** (top-left): funds (+ income / expense / avg when economy unlocks), stars, **Gregorian date + time** (starts **Sat 01 Jan 2000**), **Climate**, **speed presets**, and help. Optional stats sit behind **Shops · Elev · Tower** dropdowns (and **Goals**) — not duplicated on the core strip. Expand **Build** (open by default), then later **Goals** (after lobby) and **Economy** (after first midnight / income).
...
22. **Elevators** need **1★**; **Mid** hotels / offices, premium Condo variants, and **Housekeeping / Maintenance** need **2★**; **Upper** hotels / offices, **Security Post**, **Research Lab**, **Conference Room**, and **Fine Dining** need **3★**; **Event Hall**, **Underground Parking**, **Valet**, and **Parking Ramp** need **4★** — locked buttons show the star requirement and stay grey until earned.
...
25. Under **Hotel**, place nine types across **Base (0★)** / **Mid (2★)** / **Upper (3★)** — Base, Accessible, Mid Standard, Mid Extended, Studio, Junior Suite, Upper Standard, Upper King, Upper Suite. Rooms go **Dirty** (brownish tint) on checkout and block check-ins until a **maid** cleans them (`cleanMinutes` per type). Maids pathfind from Housekeeping to the oldest dirty room with a valid route.
...
30. Room buttons show a compact **cost · income** tag (e.g. `Small Office $28k · $2.2k/d`, `Condo $80k · $150k once`, `Elevator $100k/fl · -$3k/d`); Build tool detail and Selection spell out full cost, income at the current tier, and any daily upkeep.
...
32. **Market climate** starts at **Normal** (Recession · Slow · Normal · Strong · Boom) and may shift on the **1st of each Gregorian month**. Climate scales daily disposable spend, how many rent/sale price tiers the market tolerates, and **hotel/office fill + luxury price-tier pressure** (budget Base rooms hold up in weak climates; Mid/Upper fill and high tiers need Strong/Boom).
33. Agents use four **wealth bands** — **Basic / Mid / Upper / Premium** — plus **Street** walk-ins. Daily disposable budget follows the band (then × climate). Hotel guests and office workers match room luxury via tower mix + acceptance; condo living rooms still map via stars until the condo catalog slice. Price tier on the unit does **not** change the band.
34. Under **Office**, place nine types across **Base (0★)** / **Mid (2★)** / **Upper (3★)** — Micro, Studio, Small, Mid Office, Professional Suite, Team Bay, Upper Office, Corner Suite, Corporate Floor. Desk hire rolls wealth then only fills matching offices (same climate tables as hotels). Large firms may be roleplayed by placing several rooms (no firm entity yet).
35. **Deferred** (not in this slice): Demand graph UI, proximity/noise/crime heatmaps, spa/gym amenities, condo luxury catalog, multi-room firm tenants.
36. Shop visits spend **random dollars** (`1 … min(shop list price, remaining budget)`); agents skip shops they cannot afford (e.g. Basic budget vs Restaurant). Shop income is **batched at midnight** from **dollars spent that day**, not flat `visits × list price`. Selection shows today’s visits, **yesterday**, and a **7-day average**; the **Shops** top-bar dropdown shows tower-wide yesterday + 7-day avg shop visits.
37. Under **Utility**, place **Conference Room** at **3★** (~8×1). Each midnight, eligible Conference halls earn **daily meeting income** scaled by **office worker population**, hall capacity, stars, and climate. Select a Conference to see **Est. daily meetings: $…** in Selection.
38. Earn **4★** to unlock **Event Hall** (~12×2). Event Halls do not earn daily meetings; they host **major events** when at least one is placeable.
39. **Major events** schedule every ~2–3 weeks: foreshadow **2 days** ahead, run **1–3 days**, book Event Hall(s), pay a **lump sum at start** (hotel guest pop × stars × booked capacity), and **pause daily meetings only on booked halls**. A **banner** pops for upcoming / live / ending majors; a **scrolling ticker** above the top dashboard cycles events, serious ops alerts, and quirky lines.
40. **Event visitors** spawn during majors: day crowd paths lobby → Event Hall → shops → Outside; some book vacant hotel rooms for the event. They add elevator load, shop traffic, and crime pressure like street visitors.
