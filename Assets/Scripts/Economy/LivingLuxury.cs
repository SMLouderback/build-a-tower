...
{
    /// <summary>
    /// Shared wealth mix roll, climate bias, fill multipliers, and demand floors for living units.
    /// </summary>
    public static class LivingLuxury
    {
        ...
        /// <summary>
        /// Minimum demand chance for living-unit payout. Base rooms in Recession keep
